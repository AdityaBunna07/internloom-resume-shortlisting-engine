...
For separate role quotas, use the **Multi-role hiring plan** field with one role per line: `Role - Required Skills - Preferred Skills - CGPA - Min Slots`. InternLoom produces a separate shortlist table and CSV export for each role.
